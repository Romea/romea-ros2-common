...
public:
  ...
  const DataType & command() const { return data_; }
...
{
public:
  DataListener(std::shared_ptr<rclcpp::Node> node, const std::string & topic_name)
  {
...
private:
  ...
  void callback_(typename MsgType::ConstSharedPtr msg) { this->data_ = to_cmd_(*msg); }
