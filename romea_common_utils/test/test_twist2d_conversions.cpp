...
public:
  ...
  void SetUp()override
  {
    ...
    romea::ros2::to_ros_msg(stamp, frame_id, romea_twist2d, ros_twist2d_msg);
  }
...
{
  EXPECT_EQ(romea::ros2::extract_time(ros_twist2d_msg).nanoseconds(), stamp.nanoseconds());
...
{
  romea::core::Twist2D romea_tsist2d_bis = romea::ros2::to_romea(ros_twist2d_msg.twist);
