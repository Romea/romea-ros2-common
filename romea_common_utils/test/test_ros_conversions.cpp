...
#if ROS_VERSION==1
using GeometryMsgVector3 = geometry_msgs::Vector3
using GeometryMsgQuaternion = geometry_msgs::Quaternion
using GeometryMsgTransform =  geometry_msgs::Transform;
using DiagnosticMsgDiagnosticStatus = diagnostic_msgs::DiagnosticStatus;
#else
